...
## Dependencies
Realtime Interview; Assessment Engine; Human Review data.
...
## Architecture Notes
Versioned eval harness with golden datasets, deterministic schemas, adversarial/fairness paired cases, prompt/guardrail version comparisons, trace metadata and CI regression thresholds.
...
## Tasks / Iterations
1. **NOT STARTED** — M10.1 — Eval harness: interviewer/assessment/guardrails/fairness/adversarial/realtime structure.
...
11. **NOT STARTED** — M10.11 — CI regression gates: deterministic first, bounded live-model checks where required.
...
## AI / Eval Review
AI evals are mandatory product tests: grounding, evidence validity, interviewer behavior, prompt injection resistance, fairness pairs, schema correctness and failure handling must be measurable.
