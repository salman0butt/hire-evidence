...
## Current evidence
M00 is integrated on `main` at `64ebeb4…`, CI #57. M01 draft PR #3 remains open/unmerged. M01.1–M01.5 are provider-independently verified. M01.6 profile/RLS is implemented and reviewed at `e9c2ad64…`, CI #130, but remains short of VERIFIED until real Supabase cross-user isolation is executed. M01.7 provider-independent mobile/keyboard/auth-entry browser coverage is verified at `061762ec…`, CI #134. Provider-backed auth/profile E2E and RLS isolation remain external evidence blockers, so M01 remains IMPLEMENTING.
