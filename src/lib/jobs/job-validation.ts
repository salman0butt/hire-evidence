...
export function validateJobInput(input: RawJobInput): JobValidationResult {
  ...
  return {
    ...
    value: {
      title,
      department: normalizedOptional.department ?? null,
      description: normalizedOptional.description ?? null,
      responsibilities: normalizedOptional.responsibilities ?? null,
      seniority: normalizedOptional.seniority ?? null,
      employmentType: normalizedOptional.employmentType ?? null,
      location: normalizedOptional.location ?? null,
      salaryRange: normalizedOptional.salaryRange ?? null,
      interviewInstructions: normalizedOptional.interviewInstructions ?? null,
      requirements,
    },
  };
}
